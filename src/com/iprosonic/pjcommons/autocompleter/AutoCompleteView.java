package com.iprosonic.pjcommons.autocompleter;
...
public class AutoCompleteView 
{
	...
	public List<String> completeText(String query) {
		...
		getLocations().put("CO_JALORE", "CO_JALORE");
		getLocations().put("ASP_BINMAL", "ASP_BINMAL");
		getLocations().put("CO_BINMAL", "CO_BINMAL");
		getLocations().put("SP_JALORE", "SP_JALORE");
		getLocations().put("SHO_AHORE", "SHO_AHORE");

		getLocations().put("SP_JALORE", "SP_JALORE");
		getLocations().put("SHO_SAYALA", "SHO_SAYALA");
		getLocations().put("SHO_BAGRA", "SHO_BAGRA");
		getLocations().put("SHO_BAGORA", "SHO_BAGORA");
		getLocations().put("ASP_JALORE", "ASP_JALORE");

		getLocations().put("ASP_JALORE", "ASP_JALORE");
		getLocations().put("SHO_RAMSEEN", "SHO_RAMSEEN");
		getLocations().put("SHO_BINMAL", "SHO_BINMAL");

		getLocations().put("SHO_NOSRA", "SHO_NOSRA");
		getLocations().put("SHO_MAHILA", "SHO_MAHILA");

		List<String> results = new ArrayList<String>();

		for (String key : getLocations().keySet()) {
			String loct = getLocations().get(key);
			results.add(loct);
